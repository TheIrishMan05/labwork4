...
import se.ifmo.weblab4.components.CustomAuthentication;
import se.ifmo.weblab4.models.Point;
import se.ifmo.weblab4.utils.AreaChecker;
...
public class PointService {
    ...
    public void insert(Point point) {
        ...
        String sql = "INSERT INTO point (id, x, y, r, hit, userId) VALUES (:id, :x, :y, :r, :hit, :userId) RETURNING id";
